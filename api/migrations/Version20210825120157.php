...
final class Version20210825120157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, preview_image_id INT DEFAULT NULL, detail_image_id INT DEFAULT NULL, game_id INT DEFAULT NULL, popular_game_id INT DEFAULT NULL, header VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, time_to_read INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, og_title VARCHAR(255) DEFAULT NULL, og_description VARCHAR(255) DEFAULT NULL, key_words VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E66FAE957CD (preview_image_id), UNIQUE INDEX UNIQ_23A0E66CB7BCCB6 (detail_image_id), INDEX IDX_23A0E66E48FD905 (game_id), INDEX IDX_23A0E6642800F07 (popular_game_id), INDEX article_slug_index (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, og_title VARCHAR(255) DEFAULT NULL, og_description VARCHAR(255) DEFAULT NULL, key_words VARCHAR(255) DEFAULT NULL, INDEX IDX_389B783E48FD905 (game_id), INDEX tag_slug_index (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E6642800F07 FOREIGN KEY (popular_game_id) REFERENCES game (id)');
